...
models with high variability that do not perform well on their own. 
...
machines, neural networks, naive Bayes classifiers, and so on. Each of these has 
...
GBM or XGBoost have become de-facto standard approaches for many data scientists 
