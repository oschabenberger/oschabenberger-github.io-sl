...
This is a Negative Binomial distribution with mean $\Exp[Y] = \alpha\beta$ and variance $\Var[Y] = \alpha\beta(1+\beta)$.
The Negative Binomial is overdispersed relative to the Poisson by the factor $(1+\beta)$.
