...
with since they turn products into summations and exponents into multipliers.
...
-   are efficien in that no other estimator has an asymptotically smaller mean squared error
...
working on the log scale is much simpler. The log-likelihood function for this 
problem is given by
...
$$ 
with respect to $\bbeta$. Applying the results about matrix differentiation from
...
does not depend on the intrinsic variability of the data. However, the variability 
